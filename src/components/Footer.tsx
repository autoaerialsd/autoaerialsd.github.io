    ...
    >
      <div className="max-w-[960px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          <p className="font-condensed text-[0.82rem] tracking-[0.08em]" style={{ color: '#888' }}>
            <a href="tel:2066785640" className="no-underline transition-colors duration-200 hover:text-[#38bdf8]" style={{ color: '#888' }}>
              206-678-5640
            </a>
            {' · '}
            <a href="mailto:rod@autoaerials.com" className="no-underline transition-colors duration-200 hover:text-[#38bdf8]" style={{ color: '#888' }}>
              rod@autoaerials.com
            </a>
            {' · '}
            <a href="mailto:autoaerialssd@gmail.com" className="no-underline transition-colors duration-200 hover:text-[#38bdf8]" style={{ color: '#888' }}>
              autoaerialssd@gmail.com
            </a>
          </p>
          <p className="font-condensed text-[0.75rem] tracking-[0.1em]" style={{ color: '#555' }}>
            © 2026 Auto Aerials SD · Roderick Rutley · San Diego, CA · FAA Part 107 Certified
          </p>
        </div>
      </div>
    </footer>
